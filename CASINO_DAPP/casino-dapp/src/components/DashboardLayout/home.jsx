                ...
                <div className="col-md-12 align-items-center justify-content-center d-flex tw-p-0">
                  <div className="text-sm mb-0 font-weight-bold text-center">
                    <div className="object-cover overflow-hidden w-100 h-100">
                      <Image
                        priority={true}
                        className="navbar-brand-img pb-1 tw-max-w-lg tw-max-h-lg h-100 w-100"
                        src={rouletteImg}
                        alt={'roulette'}
                      />
                    </div>
                    <span
                      id="roulette-text"
                      className="tw-text-xl tw-text-[#ffd700] tw-font-semibold"
                    >
                      Wheel of Fortune
                    </span>
                  </div>
              ...
              <div className="row">
                <div className="col-lg-12">
                  <div className="d-flex flex-column h-100 text-center">
                    <h5
                      className="font-weight-bolder tw-mb-2"
                      style={{ color: '#ffffff' }}
                    >
                    ...
                    <p className="tw-mb-1" style={{ color: '#8b959e' }}>
                      <span id="span-welcome">
                        ...
                        <b>
                          <u>
                            <a
                              href={'https://github.com/MiguelGGMM/WEB3_CASINO'}
                              target="_blank"
                            >
                              project
                            </a>
                        ...
                        is to exemplify how blockchain technology can be used to
                        build a totally transparent open source web3 casino, rid
                        of owner priviledges, using trustfully third party
                        services for randomizing bets and get price of tokens.
                        Using smart contracts designed and deployed on arbitrum
                        blockchain and leading edge technology like react, next,
                        bootstrap, tailwind and open source web3 libraries that
                        allows user authenticate himself, retrive contract data
                        and sign transactions in order to perform bets.
                      </span>
                    </p>
                  </div>
                </div>
          ...
          <div className="row align-items-center justify-content-lg-between">
            <div className="col-lg-6 mb-lg-0 mb-4" style={{ padding: '0' }}>
              <div className="copyright text-center text-sm text-muted text-lg-start">
                ...
                by
                <a
                  href="https://github.com/MiguelGGMM"
