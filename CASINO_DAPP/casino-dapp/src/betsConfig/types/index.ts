...
export type customDollarPrizeSubtypeKeys =
  keyof typeof contractConfig.customDollarPrizeSubtype
export type customDollarPrizeSubtypeValues =
  (typeof contractConfig.customDollarPrizeSubtype)[customDollarPrizeSubtypeKeys]

export type styleOption = { backgroundColor: string; textColor: string }
export interface imageTypeBasic {
  optionsSize: 1
  offsetX: 0
  sizeMultiplier: 1
  landscape: false
