...
function toggleSidenav(newState = 'toggle') {
    const sidenav = document.getElementById('sidenav-main');
    /* if(!sidenav || !body || !sidenav.classList || !body.classList) {
        let interval = setInterval(() => {
            if(toggleSidenav() == true) clearInterval(interval);
        }, 2000);
    ...
    if (newState == 'close' || body.classList.contains(className)) {
